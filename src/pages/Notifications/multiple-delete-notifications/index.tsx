...
const DeleteManyNotificationModal = ({ open, setOpen, selectedIds, onSuccess }: Props) => {
  ...
  return (
    ...
    >
      <div className="text-sm text-gray-600">
        ...
        <span className="font-bold text-red-600 text-base">{selectedIds.length}</span> thông báo đã
        chọn không?
        <br />
